    ...
    def pedidos_view():
        ...
        for data_key, pedido in pedidos_dict.items():
            ...
            for item in pedido["itens"]:
                ...
                # tenta achar o produto pelo nome (comparação case-insensitive e sem espaços extras)
                produto = next(
                    (
                        p for p in produtos
